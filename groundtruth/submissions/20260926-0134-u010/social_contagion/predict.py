...
_KINDS = {'l0b': _roll_l0b, 'ode': _roll_ode, 'ensemble': _roll_ensemble}
...
def _ode_social_contagion_min():
    ...
    STATE_HI = np.full(_NS, 10000.0)
    R_MAX = 1.5
    PHI_HALF = 0.7
    PARAMS = [('N_a', 215.0, 60.0, 3000.0, True), ('N_b', 160.0, 40.0, 3000.0, True), ('s_a', 0.006, 0.0001, 1.0, True), ('s_b', 0.0025, 0.0001, 1.0, True), ('q', 0.03, 0.001, 1.5, True), ('tau_on', 6.0, 1.0, 100.0, True), ('c_L', 0.012, 0.0001, 0.5, True), ('k_M', 0.09, 0.005, 1.5, True), ('k_ret', 15.0, 0.0, 50.0, False), ('k_conv', 0.01, 0.0, 0.2, False), ('m0', 0.25, 0.0, 0.9, False), ('k_br', 0.3, 0.0, 1.0, False)]
    ...
    _obj_q7.__dict__.update(locals())
    return _obj_q7
_ODE_BUILD = {'social_contagion_min': _ode_social_contagion_min}
_ODE_MODS = {}
...
HARD = {'adopters_a': [0.0, None], 'adopters_b': [0.0, None]}
