...
def _ode_supply_chain_min():
    ...
    RCAP = SCAP
    STATE_HI = np.array([SCAP, 10000.0, 10000.0, 1000000.0, 1000000.0, RCAP, 1.5])
    PARAMS = [('p0', 11.3, 1.0, 100.0, True), ('kc', 0.45, 0.0, 5.0, False), ('tau_c', 12.0, 2.0, 100.0, True), ('dcap', 27.0, 5.0, 300.0, True), ('kq0', 1.0, 0.1, 3.0, True), ('kl', 8.0, 0.0, 60.0, False), ('a0', 20.0, 1.0, 100.0, True), ('dem', 17.0, 1.0, 100.0, True), ('kd', 0.05, 0.02, 0.5, True), ('tau_heat', 100.0, 20.0, 1000.0, True), ('wloss', 0.5, 0.0, 0.9, False), ('kcool', 0.06, 0.01, 1.0, True)]
