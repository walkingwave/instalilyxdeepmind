...
def _ode_power_grid_min():
    ...
    MECHS = {'A': 'thermostat synchronisation (always on)', 'B': 'droop governor (always on)', 'C': 'unused'}
    N_SUB = 2
    ...
    IC0 = 0.15
    SH_IC0 = 0.5
    PARAMS = [('d0', 126.0, 60.0, 250.0, False), ('d1', 21.5, 0.0, 80.0, False), ('w', 0.1, 0.03, 0.4, True), ('zeta', 0.28, 0.02, 1.0, True), ('kick', 0.49, 0.0, 1.0, False), ('Dsat', 3.7, 0.5, 100.0, True), ('kf', 0.0225, 0.005, 0.3, True), ('k_asym', 2.7, 0.0, 4.0, False), ('c_r', 0.59, 0.0, 2.0, False), ('s0', 0.374, 0.05, 0.9, False), ('k_c', 72.0, 10.0, 500.0, True)]
    ...
    _obj_q7.__dict__.update(locals())
    return _obj_q7
_ODE_BUILD = {'power_grid_min': _ode_power_grid_min}
_ODE_MODS = {}
