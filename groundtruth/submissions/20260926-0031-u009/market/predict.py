...
def _ode_market_min():
    ...
    STATE_HI = np.array([10000.0, 10000.0, 50.0, 10000.0, 10000.0])
    TAU_B = 2.7
    TAU_M = 10.0
    W_LO = 10.0
    PARAMS = [('v0', 2.2, 0.5, 6.0, True), ('d0', 91.0, 60.0, 130.0, False), ('a_t', 28.0, 2.0, 100.0, True), ('a_r', 2.0, 0.0, 30.0, False), ('tau_f', 5.0, 1.5, 20.0, True), ('k_sd', 0.025, 0.005, 0.3, True), ('k_su', 0.08, 0.005, 0.5, True), ('frac', 0.42, 0.05, 0.95, False), ('k_r', 7.0, 0.2, 60.0, True), ('a_x', 47.0, 0.0, 120.0, False), ('k_m', 1.5, 0.0, 4.0, False), ('p_lo', 75.0, 20.0, 90.0, False)]
    ...
    _obj_q7.__dict__.update(locals())
    return _obj_q7
_ODE_BUILD = {'market_min': _ode_market_min}
_ODE_MODS = {}
