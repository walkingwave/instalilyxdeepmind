...
def _ode_wildlife_min():
    ...
    MECHS = {'A': 'finite food stock (always on)', 'B': 'saturating harvest (always on)', 'C': 'unused'}
    N_SUB = 2
    STATE = ['PN', 'LN', 'QN', 'PS', 'LS', 'QS']
    _NS = len(STATE)
    STATE_LO = np.zeros(_NS)
    STATE_HI = np.array([10000.0, 10000.0, 1000.0, 10000.0, 10000.0, 1000.0])
    PARAMS = [('r', 0.3, 0.05, 1.5, True), ('c', 40.0, 3.0, 500.0, True), ('dl', 0.00064, 1e-05, 0.1, True), ('rho', 0.033, 0.005, 0.5, True), ('hq', 0.032, 0.001, 1.0, True), ('qh', 10.0, 0.05, 50.0, True), ('s', 0.19, 0.003, 0.5, True), ('q0', 1.55, 0.1, 20.0, True), ('q1', 0.0075, 0.0001, 0.5, True), ('ks', 0.83, 0.3, 1.5, False)]
