...
def _ode_social_contagion_min():
    ...
    R_MAX = 1.5
    PHI_HALF = 0.7
    PARAMS = [('N_a', 220.0, 60.0, 3000.0, True), ('N_b', 150.0, 40.0, 3000.0, True), ('s_a', 0.02, 0.0001, 1.0, True), ('s_b', 0.005, 0.0001, 1.0, True), ('q', 0.05, 0.001, 1.5, True), ('k_inc', 1.0, 0.0, 5.0, False), ('tau_on', 15.0, 1.0, 100.0, True), ('phi_max', 0.8, 0.0, 1.0, False), ('c_L', 0.015, 0.0001, 0.5, True), ('k_M', 0.1, 0.005, 1.5, True), ('k_ret', 20.0, 0.0, 50.0, False), ('m0', 0.3, 0.0, 0.9, False)]
