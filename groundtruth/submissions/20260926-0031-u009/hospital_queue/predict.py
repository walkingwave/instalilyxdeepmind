...
def _ode_hospital_queue_min():
    ...
    STATE_HI = np.array([333.0, 333.0, 333.0, 333.0, 10000.0, 1.0])
    Q_W = 6.0
    TAU_FAT = 30.0
    K_DRAIN = 3.0
    PARAMS = [('lam0', 11.5, 5.0, 25.0, False), ('c_a', 1.5, 0.2, 6.0, True), ('c_t', 2.0, 0.3, 10.0, True), ('tau_a', 2.0, 0.7, 15.0, True), ('chairs', 30.0, 5.0, 300.0, True), ('beds', 40.0, 5.0, 300.0, True), ('ot_gain', 0.4, 0.0, 1.5, False), ('k_fat', 0.4, 0.0, 0.9, False), ('k_l', 0.02, 0.001, 0.5, True), ('tau_w', 8.0, 1.0, 60.0, True), ('q_cap', 325.0, 250.0, 340.0, False), ('d_h', 0.05, 0.01, 1.0, True)]
